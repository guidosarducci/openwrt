...
define KernelPackage/sched-bpf
  ...
  DEPENDS:=@!LINUX_3_18 @!LINUX_4_1 @!LINUX_4_4 +kmod-sched-core
  KCONFIG:= \
	CONFIG_NET_CLS_BPF \
	CONFIG_NET_ACT_BPF \
	CONFIG_BPF_JIT=y
...
define KernelPackage/sched-bpf/install
	$(INSTALL_DIR) $(1)/etc/sysctl.d
	$(INSTALL_DATA) ./files/sysctl-core-bpf.conf $(1)/etc/sysctl.d/11-core-bpf.conf
endef
...
define KernelPackage/bpf-test
  ...
  DEPENDS:=@!LINUX_3_18 @!LINUX_4_1 @!LINUX_4_4 +kmod-sched-bpf
